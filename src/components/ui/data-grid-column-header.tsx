...
const { COLUMN_HEADER } = UI.DATA_GRID;
...
function DataGridColumnHeader<TData, TValue>({
  ...
  const headerPin = () => {
    const unpinLabel = COLUMN_HEADER.UNPIN_COLUMN_PREFIX + title;
            ...
            {column.getCanSort() && (
              <>
                ...
                >
                  ...
                  <span className="grow">{COLUMN_HEADER.SORT_ASC}</span>
                  {column.getIsSorted() === 'asc' && (
                ...
                >
                  ...
                  <span className="grow">{COLUMN_HEADER.SORT_DESC}</span>
                  {column.getIsSorted() === 'desc' && (
                    <Check className="size-4 opacity-100! text-primary" />
                  )}
                </DropdownMenuItem>
            ...
            {props.tableLayout?.columnsPinnable && column.getCanPin() && (
              <>
                ...
                >
                  ...
                  <span className="grow">{COLUMN_HEADER.PIN_LEFT}</span>
                ...
                >
                  ...
                  <span className="grow">{COLUMN_HEADER.PIN_RIGHT}</span>
            ...
            {props.tableLayout?.columnsMovable && (
              <>
                ...
                >
                  ...
                  <span>{COLUMN_HEADER.MOVE_LEFT}</span>
                </DropdownMenuItem>
                <DropdownMenuItem
                ...
                >
                  ...
                  <span>{COLUMN_HEADER.MOVE_RIGHT}</span>
                </DropdownMenuItem>
              </>
            )}
            ...
            {props.tableLayout?.columnsVisibility && visibility && (
              <DropdownMenuSub>
                <DropdownMenuSubTrigger>
                  ...
                  <span>{COLUMN_HEADER.COLUMNS}</span>
                </DropdownMenuSubTrigger>
                <DropdownMenuPortal>
                  <DropdownMenuSubContent>
                    {table
